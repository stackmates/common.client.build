...
describe('Accordion', function () {
  ...
  describe('controller', function () {
    ...
    describe('addGroup', function () {
      it('adds the specified group to the collection', function () {
        var group1, group2;
  ...
  describe('accordion-group', function () {
    ...
    var findGroupBody = function (index) {
      return groups.eq(index).find('.accordion__body').eq(0);
    };
    ...
    describe('with static groups', function () {
      ...
      beforeEach(function () {
        ...
        scope.$digest();
        groups = element.find('.accordion__group');
      });
      ...
      it('should toggele element on click', function () {
        findGroupLink(0).click();
        scope.$digest();
        expect(findGroupBody(0).scope().isOpen).toBe(true);
        findGroupLink(0).click();
    ...
    describe('with dynamic groups', function () {
      ...
      it('should react properly on removing items for the model', function () {
        scope.groups = model;
        scope.$digest();
        groups = element.find('.accordion__group');
        expect(groups.length).toEqual(2);
   ...
   describe('is-open attribute with dynamic content', function() {
    ...
    // WHY are attributes sometimes escaped?
    describe('is-open attribute with dynamic groups', function () {
      ...
      it('should have visible group body when the group with isOpen set true', function () {
        expect(findGroupBody(0).scope().isOpen).toBe(false);
        expect(findGroupBody(1).scope().isOpen).toBe(true);
      });
