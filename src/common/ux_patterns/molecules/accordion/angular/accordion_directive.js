...
angular.module('common.directives.accordion', [
  'common.directives.collapse'
])
...
.directive('accordion',
  function(){
    return {
      ...
      transclude: true,
      replace: false,
      templateUrl: 'common/components/molecules/accordion/templates/accordion.html'
    };
  }
)
...
.directive('accordionGroup',
  function($parse) {
    return {
      ...
      transclude: true,
      replace: true,
      templateUrl: 'common/components/molecules/accordion/templates/accordion-group.html',
      scope:{
        heading:'@'
      },
      controller: function() {
